export const places = [
  // ── 선전 ──
  {
    ...
    cityLabel: '선전',
    category: '기술',
    name: '바이두 아폴로 고 (Apollo Go)',
    desc: '완전 무인 Level 4 자율주행 로보택시. 쇼룸 브리핑과 실제 도심 시승 체험.',
    uxPoint: '앱 호출부터 탑승·하차까지 운전자 없는 UX 흐름. 안내 화면·소음·공간 내부 경험 분석.',
    rating: null,
    photo: null,
  },
  {
    ...
    uxPoint: '오더 → 픽업 오스크 선택 → 드론 도착 알림 → 패널 수령까지의 단계별 UX 관찰.',
    rating: null,
    photo: null,
  },
  {
